...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/shopowner')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{url('/shopowner/category/index')}}">Categories</a> <a href="#" class="current">Edit Category</a> </div>
