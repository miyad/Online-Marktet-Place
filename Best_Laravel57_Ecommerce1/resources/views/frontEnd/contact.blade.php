	...
	<div class="container">
		...
		<div class=" contact-w3">	
			<div class="col-md-5 contact-right">	
				<img src="../static/images/cac.jpg" class="img-responsive" alt="">
			...
			<div class="col-md-7 contact-left">
				...
				<ul class="contact-list">
					<li> <i class="fa fa-map-marker" aria-hidden="true"></i> Polashi Market, BUET.</li>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:example@mail.com">nazmulhasan05073@gmail.com</a></li>
					<li> <i class="fa fa-phone" aria-hidden="true"></i>+8801517078796</li>
				</ul>
				<div id="container">
					<!--Horizontal Tab-->
