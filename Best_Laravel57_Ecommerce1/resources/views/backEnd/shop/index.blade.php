...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('shop.index')}}" class="current">Shops</a></div>
                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($shops as $shop)
                        ...
                        <tr class="gradeC">
                            ...
                            <td style="vertical-align: middle;">{{$shop->price}}</td>
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                <a href="{{route('shop.edit',$shop->id)}}" class="btn btn-primary btn-mini">Edit</a>
                                <a href="javascript:" rel="{{$shop->id}}" rel1="delete-shop" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
